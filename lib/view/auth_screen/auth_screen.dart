...
//                       ),
//                       TextSpan(text: 'and ', style: textTheme.labelLarge),
//                       TextSpan(
//                         text: 'Privacy Notice.',
//                         style: textTheme.labelLarge!.copyWith(color: blue),
//                       ),
...
//                           hintText: 'Mobile Number',
//                           hintStyle:
//                               textTheme.titleSmall!.copyWith(color: grey),
//                           border: OutlineInputBorder(
//                             borderRadius: BorderRadius.circular(5),
//                             borderSide: BorderSide(
//                               color: grey,
...
//                 CommonFunctions.blankSpace(height * 0.02, 0),
//                 Text(
//                   'By enrolling your mobile phone number , you consent to receive automated security notification via text message from Amazon.\nMessage and data rates may apply.',
//                   style: textTheme.bodyMedium,
//                 ),
//                 CommonFunctions.blankSpace(height * 0.02, 0),
//                 CommonAuthButton(
...
//       onPressed: () {},
//       style: ElevatedButton.styleFrom(
//         minimumSize: Size(width * 0.85, height * 0.06),
//         backgroundColor: amber,
//       ),
//       child: Text(
//         'Continue',
...
//             Text(
//               'Condition of Use',
//               style: textTheme.bodyLarge!.copyWith(color: blue),
//             ),
//             Text(
//               'Privacy Notice',
//               style: textTheme.bodyLarge!.copyWith(color: blue),
